// ========== HELPERS ==========
      ...
      const allBottleShapes = {
        ...
        "250ml_sweet_box_top": {
          ...
          "path": "M.5.96 L.5 264.03 L350.69 264.49 L351.15 264.03 L351.15 .96 L350.69 .5 L.96 .5 L.5 .96 Z",
          "topPath": "M.96 .5 L350.69 .5",
          "bottomPath": "M.5 264.03 L351.15 264.03",
          "topIsReversed": false,
          "bottomIsReversed": false,
        ...
        if (shape && shape.type !== "rectangle") {
          ...
          if (isSweetBox) {
            ...
            if (isWideShape) {
                if (shape.name.includes("450ml")) {
                    edgeExt = 0;
                    viewExt = 0; // Adjust this value specifically for 450ml round square
                } else if (shape.name.includes("500ml")) {
                    edgeExt = 0.003;
                ...
                if (shape.name.includes("250ml")) {
                    ...
                    edgeExt = 0;
                    viewExt = 0.001; // Adjust this value specifically for 1000ml
                } else {
                    edgeExt = 0.015;
                    viewExt = 10;
                }
